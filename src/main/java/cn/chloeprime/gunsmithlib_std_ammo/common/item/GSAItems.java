...
public final class GSAItems {
    ...
    public static final Supplier<BlockItem> PURIFIED_DEBRIS = blockItem("purified_debris", GSABlocks.PURIFIED_DEBRIS);
    public static final Supplier<Item> RAW_TUNGSTEN = simpleItem("raw_tungsten");
    public static final Supplier<Item> TUNGSTEN_INGOT = simpleItem("tungsten_ingot");
    ...
    public static final Supplier<BlockItem> END_TIBERIUM_SEED_ORE = blockItem("end_tiberium_seed_ore", GSABlocks.END_TIBERIUM_SEED_ORE);
    public static final Supplier<Item> TIBERIUM_SEED = DFR.register("tiberium_seed", () -> new InfectLeavesSeed(
            GSABlocks.TIBERIUM_LEAVES,
            new Item.Properties()));
    public static final Supplier<BlockItem> TIBERIUM_LEAVES = blockItem("tiberium_leaves", GSABlocks.TIBERIUM_LEAVES);
    ...
    public static final Supplier<Item> BLUE_TIBERIUM_CRYSTAL = DFR.register("blue_tiberium_crystal", () -> new BurnableSimpleItem(50, new Item.Properties()));
    public static final Supplier<Item> N2_DYNAMITE = simpleItem("n2_dynamite");
    public static final Supplier<Item> TIBERIUM_COMPOUND = simpleItem("tiberium_compound");
    public static final Supplier<Item> TIBERIUM_ALLOY_INGOT = simpleItem("tiberium_alloy_ingot");

    private static Supplier<Item> simpleItem(String name) {
        return DFR.register(name, () -> new SimpleItem(new Item.Properties()));
    }

    private static Supplier<BlockItem> blockItem(String name, Supplier<? extends Block> block) {
        return DFR.register(name, () -> new BlockItem(block.get(), new Item.Properties()));
    }
